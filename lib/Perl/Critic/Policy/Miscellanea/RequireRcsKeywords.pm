##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/trunk/distributions/Perl-Critic-More/lib/Perl/Critic/Policy/Miscellanea/RequireRcsKeywords.pm $
#     $Date: 2013-10-25 12:42:53 -0700 (Fri, 25 Oct 2013) $
#   $Author: thaljef $
# $Revision: 4181 $
##############################################################################
...
sub default_themes   { return qw(more pbp cosmetic) }
...
define the C<$VERSION> variable like this:
    ...
    our ($VERSION) = '$Revision: 4181 $' =~ m{ \$Revision: \s+ (\S+) }x;
